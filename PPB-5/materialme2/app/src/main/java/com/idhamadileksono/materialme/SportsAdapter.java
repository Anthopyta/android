...
class SportsAdapter extends
    ...
    @Override
    public SportsViewHolder onCreateViewHolder(ViewGroup parent, int

            viewType) {
        return new SportsViewHolder(mContext,
    ...
    static class SportsViewHolder extends RecyclerView.ViewHolder
        ...
        private GradientDrawable mGradientDrawable;
        SportsViewHolder(Context context, View itemView, GradientDrawable
                gradientDrawable) {
            super(itemView);
